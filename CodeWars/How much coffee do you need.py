...
def how_much_coffee(events):
    """
    Función que según la serie de eventos, retorna cuanta cantidad de cafe necesita la persona.
    :param events: Serie de eventos en forma de lista
    """
    A = ["cw", "cat", "dog", "movie"]
    contador = 0
    for i in events:
...
if __name__ == '__main__':
    ...
    resultado = how_much_coffee(['cw','CAT','DOG'])
    print(resultado)